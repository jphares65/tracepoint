...
export default function FleetRulesPanel() {
                ...
                <div className="mb-3 flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-slate-500">
                      ...
                      vehicle inspection. Critical items can be used to identify
                      conditions that may affect vehicle availability.
                    </p>
                  </div>
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      const current = Array.isArray(rules.inspection_checklist)
                      ...
                      >
                        ...
                        {item.critical === true && (
                          <p className="mt-2 text-xs text-amber-700">
                            ...
                            determines whether an actual critical defect exists.
                          </p>
                        )}
                      </div>
                    ),
