...
do $$ declare f uuid;begin
 ...
 insert into public.firearm_inspections(department_id,firearm_id,inspection_date,inspected_by_user_id,inspection_type,result) values('00000000-0000-4000-8000-000000000011',f,current_date,'00000000-0000-4000-8000-000000000001','Routine','Pass');
end $$;
