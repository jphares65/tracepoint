...
export function fullAwsProductionAssembly(app:cdk.App,input:FullAwsProductionTarget,offline:boolean){
 ...
 const imageBuild=new ImageBuildStack(app,"tracepoint-production-full-aws-image-build",{...common,repository:compute.repository,appSecrets:compute.awsNativeAppSecrets,providerMode:"aws-native",resourceQualifier:"aws-native",productionControls:true});imageBuild.addStackDependency(compute);
