...
import {expectedMigrationCount,validateTarget} from './run-aws-postgres-rehearsal.mjs';
...
test('disposable rehearsal pins the authoritative source migration count',()=>assert.equal(expectedMigrationCount,76));
