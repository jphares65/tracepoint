...
new CognitoFoundationStack(app,'tracepoint-'+stage+'-cognito-preview',{...common,sesFromAddress:`notifications@${stage==='staging'?'staging.tracepointhq.com':'tracepointhq.com'}`,sesConfigurationSetName:`tracepoint-${stage}-cognito`});
