...
export function fullAwsProductionAssembly(app:cdk.App,input:FullAwsProductionTarget,offline:boolean){
 ...
 const cognito=new CognitoFoundationStack(app,"tracepoint-production-full-aws-cognito",{...common,taskRole:compute.taskRole});cognito.addStackDependency(compute);
