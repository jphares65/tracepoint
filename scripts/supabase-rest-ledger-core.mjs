...
export const RELATION_ORDER_COLUMNS = Object.freeze({
  ...
  platform_agency_accounts: ["department_id"],
  fleet_rules: ["department_id"],
  pilot_ammunition_workspaces: ["department_id"],
  pilot_range_workspaces: ["department_id"],
  pilot_remediation_workspaces: ["department_id"],
  permissions: ["code"],
  roles: ["code"],
