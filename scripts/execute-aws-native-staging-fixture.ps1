...
if ($result.Count -ne 1 -or $result[0].sourceCommit -ne $SourceCommit -or $result[0].sourceMigrations -ne 76 -or $result[0].awsMigrations -ne 21 -or $result[0].users -ne 3 -or $result[0].departments -ne 2 -or $result[0].syntheticOnly -ne $true) {
