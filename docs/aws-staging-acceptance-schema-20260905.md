...
Extended live run 6fe363fc-a271-4cb2-8c91-9e9b1ddd3227 passed assignment/reassignment/unassignment, assigned inventory visibility in Officer Readiness without a requirement, foreign-department officer assignment denial, non-manager create/edit denial, restricted inventory visibility, closed custody-history verification, and audit-event creation. Three disposable users and two departments plus equipment fixtures were removed; cleanup verified.
