...
const result=spawnSync(process.execPath,['--import','tsx','--test','--test-concurrency='+concurrency,...files],{stdio:'inherit'});if(result.error)throw Error('Application test process could not start');process.exitCode=result.status??1;
