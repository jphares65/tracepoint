        ...
        {showRequirementForm && canManage ? (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
            <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-slate-700 bg-slate-950 p-5">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Saving an existing equipment type updates
                its current agency requirement.
              </p>
                ...
                <select
                  ...
                  onChange={(event) => {
                    ...
                    setRequirementForm({
                      ...
                      validDays:
                        current?.valid_days?.toString() ??
                        "",
                      dueSoonDays:
                        current?.due_soon_days?.toString() ??
                        "",
                      inspectionIntervalDays:
                        current?.inspection_interval_days?.toString() ??
                        "",
                      inspectionDueSoonDays:
                        current?.inspection_due_soon_days?.toString() ??
                        "",
                      notes:
                        current?.notes ?? "",
                    });
