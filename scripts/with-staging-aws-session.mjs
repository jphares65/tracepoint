...
verify(aws(['sts','get-caller-identity','--profile','tracepoint-member-staging','--output','json'],sourceEnv));
const temporary=aws(['configure','export-credentials','--profile','tracepoint-member-staging','--format','process'],sourceEnv);
